...
function (_Component) {
  ...
  _createClass(ImageGrid, [{
    ...
    value: function render() {
      console.log('posts', this.props.posts); // const posts = this.props.posts.map((post, index) => {
      //     return (
      //         <div className="w-100 md:w-1/3 sm:w-1/2 cursor-pointer" key={index}>
      //
      //                 <Link
      //                     as={`/post/${post.slug}`}
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "flex flex-wrap max-w-3xl"
      });
    }
  }]);
...
//# sourceMappingURL=category.js.90c634a732b3c38bc026.hot-update.js.map