...
class Taller extends Component {
    render() {
        ...
        return (
            ...
            <div className="flex-1 text-left p-6 md:pl-24 md:pt-16 md:-ml-24 md:-mt-8 md:-mb-16 md:-mr-10" style={{
               background:'url(/static/images/festival-background'+this.props.index%2+'.png)',
               backgroundSize: 'cover'
             }}>
              <div className="p-2 md:p-10 md:pr-24">
                  <h1 className='font-menu uppercase text-2xl mb-6' dangerouslySetInnerHTML={{__html: this.props.post.title.rendered}}></h1>
